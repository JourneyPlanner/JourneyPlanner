...
return [
     ...
     */
    "route" => "verification.update.verify",
     ...
     */
    "mailable_for_first_verification" => \App\Mail\EmailConfirmation::class,
     ...
     */
    "mailable_for_new_email" => \App\Mail\EmailUpdateConfirmation::class,
];

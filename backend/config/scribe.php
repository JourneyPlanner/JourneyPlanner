...
use App\Generators\TagGroupsOpenApiGenerator;
...
return [
    ...
    'description' => 'JourneyPlanner API - for internal use only',
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your token by visiting /token.',
    ],

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => 'Welcome to the JourneyPlanner API documentation. This API is for internal use only.',
    ...
    'openapi' => [
        ...
        'generators' => [TagGroupsOpenApiGenerator::class],
    ],
    ...
    'logo' => 'https://journeyplanner.io/web-app-manifest-512x512.png',

  ...
  <div class="w-full flex justify-center items-center font-nunito dark:bg-background-dark">
    ...
    <div class="xl:w-1/3 md:w-1/4 sm:w-0 w-0 h-[90vh] dark:background-dark">
      ...
      <div class="overflow-hidden">
        ...
        <SvgBalloon class="absolute xl:w-[4%] md:w-[5%] md:left-[28vh] w-0 top-[45vh] left-[45vh] z-0" />
        <SvgBalloon class="absolute xl:w-[7%] md:w-[8%] left-[68vh] w-0 top-12" />
      </div>
    </div>
    <div
      ...
      <div
        ...
        <fieldset id="outerBlock"
          ...
          <form @submit="onSubmit" class="w-5/6">
            ...
            <FormPassword id="password" name="password" :feedbackStyle="true" translationKey="form.input.password" />
          ...
          <NuxtLink to="/register" class="dark:text-white underline mt-auto font-nunito font-semibold my-1">
            <T keyName="form.text.no_account" />
          </NuxtLink>
        </fieldset>
      </div>
      <SvgCloudReversed class="xl:w-0 md:w-0 sm:w-[30vh] w-[30vh] z-0 absolute top-[50vh] overflow-hidden -left-4" />
      <SvgBalloonWithPeople
        class="xl:w-0 md:w-0 sm:w-[30vh] w-[30vh] z-0 absolute sm:-right-12 -right-24 top-[30vh] overflow-hidden" />
    </div>
    <div class="xl:w-1/3 md:w-1/4 sm:w-0 w-0 h-[90vh] flex justify-center items-center">

...
<template>
    <div>
        <div class="flex justify-end">
            <button
                class="mr-32 mt-10 rounded-xl border-2 border-cta-border bg-input px-2 py-1 text-base font-semibold hover:bg-cta-bg dark:bg-input-dark dark:text-input dark:hover:bg-cta-bg-dark"
                @click="$router.back()"
            >
                <T key-name="common.back" />
            </button>
        </div>
        <div class="-mt-10 font-nunito text-text dark:text-input">
            <div class="mx-5 mt-10 flex flex-col sm:mx-20 lg:mx-96">

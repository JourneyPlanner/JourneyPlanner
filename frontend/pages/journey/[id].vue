  ...
  <div class="flex flex-col font-nunito text-text dark:text-white">
    ...
    <div class="mt-[12vh] flex h-fit flex-wrap">
      <div class="flex w-full items-center justify-center md:hidden">
        <div class="group w-[90%] [perspective:1000px] sm:w-5/6" @click="flip">
          <div
          ...
          >
            <div class="bg-none md:w-2/5 lg:w-1/3">
              ...
              >
                ...
                ></div>
                <p class="ml-16 text-xl font-bold text-white">JourneyPlanner</p>
                ...
                >
                  <div class="mb-2 mt-1 grid w-full grid-cols-4">
                    ...
                    <div class="relative -mt-1 w-full">
                      <SvgStripes class="absolute right-0 z-0 w-[7.4rem]" />
                      <div
              ...
              <div class="flex h-5/6">
                ...
                >
                  <div class="relative flex h-full w-full flex-col items-end">
                    ...
                    <SvgStripes class="z-0 md:w-2/3 lg:w-1/2" />
                  </div>
                </div>
              </div>
            </div>
      ...
      >
        ...
        >
          <div
            class="absolute ml-5 inline-block h-7 w-7 self-center rounded-full bg-border-gray"
          ></div>
          <p class="ml-14 text-xl font-bold text-white">JourneyPlanner</p>
          <div class="flex h-full w-full items-center justify-end">
            <SvgAirplaneIcon class="mr-5 w-7" />
          </div>
        </div>
            ...
            <div class="relative flex h-full w-full flex-col items-end">
              ...
              >
                <div class="flex-column w-25rem flex gap-3">
                  <div>
                    <span class="mb-1 block text-lg font-medium">
                      <T keyName="sidebar.invite.link" />
                    </span>
                    <div class="flex">
                      <input
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <!-- left side -->
              <div class="bg-black relative rounded-xl p-1 py-2 lg:p-2 lg:py-3">
                <!-- background grid of black squares -->
                <div class="absolute inset-0 grid grid-rows-2">
                  <div
                    class="rounded-t-md bg-gradient-to-br from-gradient-start to-gradient-end dark:from-gradient-start-dark dark:to-gradient-end-dark"
                ...
                <!-- time numbers -->
                <span class="top-50 absolute">{{ hundredsDays }}</span>
            ...
            >
              ...
              <p v-else class="w-full pl-1 text-base font-bold lg:text-lg">

        ...
        <div class="text-center sm:w-3/4 w-full -mt-20 h-3/4 z-20">
          <fieldset id="outerBlock"
            ...
            <form @submit="onSubmit" class="w-4/5">
              <FormInput id="email" name="email" autocomplete="email" translationKey="form.input.email" />

              <FormInput id="firstName" name="firstName" autocomplete="given-name"
                translationKey="form.input.first.name" />

              <FormInput id="lastName" name="lastName" autocomplete="family-name"

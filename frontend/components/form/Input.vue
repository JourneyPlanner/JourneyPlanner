...
<template>
  <div class="relative my-5">
    <input :type="type || 'text'" :id="id" :name="name" v-model="value" :autocomplete="autocomplete || 'off'"
      ...
      placeholder=" " @focus="isFocused = true" @blur="isFocused = false" @input="$emit('input', $event)" />
    <label :for="id"
    ...
    <div class="h-1.5 text-left w-full">
      <span class="ml-3 text-error dark:text-error-dark dark:font-bold text-xs" :class="{

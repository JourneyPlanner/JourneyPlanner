...
<template>
    <div class="relative my-5">
        <input
            ...
            class="placeholder:text-transparent peer w-full rounded-lg border-2 border-calypso-300 bg-natural-50 px-2.5 pb-1 pt-4 text-base font-bold text-text focus:outline-none focus:ring-1 dark:bg-natural-800 dark:text-natural-50"
            placeholder=" "

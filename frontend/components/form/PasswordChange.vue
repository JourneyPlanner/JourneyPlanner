        ...
        <div class="flex h-full flex-col pl-8">
            ...
            <div class="flex items-center pl-6 pt-4">
                <div class="flex w-full flex-col items-center">
                    ...
                    <div
                        v-if="passwordInvalid"
                        class="-ml-10 flex w-full items-start text-sm text-mahagony-600"
                    >
                        <T
                            key-name="dashboard.user.settings.password.too.short"
                        />
                    </div>
                    <div
                        class="mb-2 mr-10 mt-3 flex w-full items-start text-sm dark:text-natural-50"
                    >
                        <T
                            key-name="dashboard.user.settings.confirm.new.password"
                        />
                    ...
                    >
                        <T
                            key-name="dashboard.user.settings.passwords.not.match"
                        />
                    </div>
                </div>
            </div>
